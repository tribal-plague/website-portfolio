...
export const sans = { fontFamily: '"Inter", "Helvetica Neue", Helvetica, Arial, sans-serif' };
...
export const EXPERIENCES = [
  {
    ...
    summary:
      "Led all design output for Zopper's brand and digital presence — sole designer and developer of the Webflow website, performance marketing creatives for IIT/IIM campaigns, and brand identity that drove measurable business outcomes.",
    highlights: [
      "Sole designer and developer of Zopper's Webflow website, driving a 25% increase in click rates.",
      "Designed landing pages and ad creatives for premier institute campaigns for IITs and IIMs, achieving CTRs up to 2.09% and 40% lead conversion rates.",
      "Leveraged AI tools to produce ad creatives and campaign collaterals at scale across multiple institutes, generating ₹1 Cr+ in total premium and strengthening marketing output.",
      "Ran A/B testing across landing pages and ad creatives, consistently optimising performance to achieve CPLs as low as ₹215 and Premium ROAS up to 12.6x.",
